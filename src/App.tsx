      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">BeMore</h1>
              <p className="text-sm text-gray-500">AI 심리 상담 시스템</p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="bg-white rounded-lg shadow-md p-4">
              <h2 className="text-lg font-semibold text-gray-700 mb-3">실시간 영상</h2>
              ...
              <button
                ...
                className="mt-3 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition text-sm"
              >
                STT 텍스트 변경
              </button>
            </div>
            ...
            {/* AI 채팅 */}
            <div className="bg-white rounded-lg shadow-md p-4">
              <h2 className="text-lg font-semibold text-gray-700 mb-3">AI 대화</h2>
              <div className="h-96">
                <AIChat />
              </div>
            </div>
          ...
          <div className="space-y-4">
            {/* 감정 카드 */}
            <div className="bg-white rounded-lg shadow-md p-4">
              <h2 className="text-lg font-semibold text-gray-700 mb-3">현재 감정</h2>
              <EmotionCard emotion={currentEmotion} confidence={0.85} />
            </div>

            {/* VAD 모니터 */}
            <div className="bg-white rounded-lg shadow-md p-4">
              <h2 className="text-lg font-semibold text-gray-700 mb-3">음성 분석</h2>
              <VADMonitor metrics={demoVADMetrics} />
            </div>

            {/* 시스템 정보 */}
            <div className="bg-white rounded-lg shadow-md p-4">
              <h2 className="text-lg font-semibold text-gray-700 mb-3">시스템 상태</h2>
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-green-600 font-medium">● 감지 중</span>
                </div>
                <div className="flex justify-between">
