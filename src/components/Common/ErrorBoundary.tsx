      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
          <div className="max-w-md w-[92%] sm:w-full bg-white dark:bg-gray-800 rounded-xl shadow-soft p-6 text-center">
            ...
            <button onClick={this.handleReload} className="mt-4 px-4 py-2 min-h-[44px] rounded-lg bg-primary-600 hover:bg-primary-700 text-white transition-colors">새로고침</button>
          </div>
        </div>
      );
    }
